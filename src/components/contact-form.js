...
// custom validation for redux-form
...
class ContactForm extends Component {
    ...
    componentWillReceiveProps = nextProps => { // Receive contact data asynchronously
        ...
        if (contact._id !== this.props.contact._id) this.props.initialize(contact) // Initialize form only once
    }
...
export default reduxForm({form: 'contact', validate})(ContactForm) // custom validation for redux-form